...
class Index20News {
	...
	def setup() {
		...
		Query q = new QueryParser(Version.LUCENE_46, IndexWrapperG.FIELD_CONTENTS, analyzer).parse(querystr);
	...
	throws IOException {
		...
		Field categoryField = new StringField(IndexWrapperG.FIELD_CATEGORY, categoryNumber.toString(), Field.Store.YES);
